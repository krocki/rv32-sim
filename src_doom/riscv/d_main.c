...
// D_AddFile
//
void debug_puts(const char *str);  // Forward declaration
...
void D_DoomMain (void)
{
    ...
    // Skip setbuf - not needed for our embedded system
    // setbuf (stdout, NULL);
    modifiedgame = false;
    ...
    printf ("W_Init: COMPLETE - WAD files loaded successfully\n");
    ...
    HU_Init ();
    printf ("HU_Init: COMPLETE\n");

    printf ("ST_Init: Init status bar.\n");
    ST_Init ();
    printf ("ST_Init: COMPLETE\n");
